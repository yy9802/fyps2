...
function loader_Fun() {
    ...
    var callbacks = [];
    var imgs = ['images/AdviseVertical.png', 'images/fyps-p1-1.png', 'images/fyps-p1-2.png', 'images/fyps-p1-3.png', 'images/fyps-p1-4.png', 'images/fyps-p1-5.png', 'images/fyps-p1-6.png', 'images/fyps-p1-7.png', 'images/fyps-p1-8.png', 'images/fyps-p1-9.png', 'images/fyps-p1-10.png', 'images/fyps-p1-11.png', 'images/fyps-p1-12.png', 'images/fyps-p1-13.png', 'images/fyps-p1-14.png', 'images/fyps-p1-15.png', 'images/fyps-p1-16.jpg', 'images/fyps-p1-20.png', 'images/fyps-p1-20-ft.png', 'images/fyps-p1-1-ft.png'];
...
$(document).ready(
    ...
    function() {
        ...
        if (navigator.language) {
            ...
            console.log('nnavigator.browserLanguage：' + language);
        }

        if (language == 'zh-hk' || language == 'zh-tw') { //香港&台湾
            $('.p1-title2 img').attr('src', 'images/fyps-p1-1-ft.png');
            $('.p1-video-mc-bg2 img').attr('src', 'images/fyps-p1-20-ft.png');
        } else {
            $('.p1-title2 img').attr('src', 'images/fyps-p1-1.png');
            $('.p1-video-mc-bg2 img').attr('src', 'images/fyps-p1-20.png');
        }
